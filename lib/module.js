...
import { defineNuxtModule, addPlugin, addDevServerHandler, extendPages, installModule, NitroOptions } from '@nuxt/kit'
...
export const register = Object.freeze({
  ...
  middlewares (storiesDir, staticHost = {}) {
    ...
    /** @type Array<NitroOptions.NitroDevEventHandler> */
    const middlewares = [
      // Example: fetch /nuxtStories/stories.db
      { route: mount, handler: serveStatic(`./${storiesDir}`) },
      {
