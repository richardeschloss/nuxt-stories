import { Buffer as BufferClient } from 'buffer/index.js' // Provides browser polyfill
...
globalThis.Buffer = globalThis.Buffer || BufferClient // TBD
...
Object.assign(
  renderer,
  {
    ...
    table (header, body) {
      ...
      return `<table class="table table-striped"><thead>${hdr}</thead><tbody>${body}</tbody></table>`
    }
  }
)
