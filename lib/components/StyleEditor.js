...
export default {
  render () {
    ...
    const fontSelect = h(Dropdown, {
      ...
      onItemSelected: (item) => {
        this.formatting.font = item.value
        this.appliedStyles['font-family'] = this.formatting.font
        this.input = fromStyleJson(this.appliedStyles)
        this.updateStyles()
      }
    })
  ...
  methods: {
    initStyles () {
      ...
      this.formatting.font = this.appliedStyles['font-family']
        ? this.appliedStyles['font-family']
        : window.getComputedStyle(this.state.stylingElms[0])['font-family']
      this.updateBtns()
    ...
    updateStyles () {
      ...
      if (this.state.stylingElms.length > 0) {
        ...
        this.formatting.font = window.getComputedStyle(this.state.stylingElms[0])['font-family']
        this.appliedStyles = toStyleJson(this.state.stylingElms[0])
    ...
    setStyles () {
      if (this.state.stylingElm) {
        this.state.stylingElm.style = this.input
