...
export default defineNuxtPlugin(async (nuxtApp) => {
  ...
  Object.entries(components).forEach(([name, comp]) => {
    if (!nuxtApp.vueApp.component(name)) {
      comp.name = 'AsyncComponentWrapper' // TBD: a fake name to get it showing up in Component Browser
      nuxtApp.vueApp.component(name, comp.default || comp) // TBD
    }
  })
